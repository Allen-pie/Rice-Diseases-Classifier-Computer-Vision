...
export function FeatureSection9() {
  return (
    <section
      id="how-it-works"
      className="bg-secondary mt-5 mb-[150px] pb-10 border-b scroll-mt-52"
    >
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-6 lg:grid-cols-4">
          ...
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground">
                Submit a clear photo of the rice leaf using your phone or
                computer.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground">
                Instantly receive the predicted class such as Leaf Blast, Brown
                Spot, Bacterial Blight, or Healthy.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground">
                View disease descriptions and get actionable recommendations for
                treatment.
              </p>
            </div>
          </div>
